...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "dashboard.subtitle": "将 DeepSeek 模型接入 Cursor 编辑器",
        "dashboard.settings.general": "常规设置",
        "dashboard.settings.tools": "工具",
    ...
    "en-US": {
        ...
        "dashboard.subtitle": "Connect DeepSeek models to the Cursor editor",
        "dashboard.settings.general": "General",
        "dashboard.settings.tools": "Tools",
        "dashboard.url.label": "Cursor Base URL",
